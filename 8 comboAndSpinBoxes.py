...
exercise_spin_value = tk.StringVar()
exercise_spin = ttk.Spinbox(window, textvariable = exercise_spin_value, values = exercise_letters)
exercise_spin.pack()

exercise_spin.bind('<<Decrement>>', lambda event: print(exercise_spin_value.get()))
