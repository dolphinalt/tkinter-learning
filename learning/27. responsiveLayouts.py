...
class App(tk.Tk):
    ...
    def create_small_layout(self):
        ...
        ttk.Label(self.frame, text = 'Label 1', background = 'green').pack(expand = True, fill = 'both', padx = 10, pady = 5)
        ttk.Label(self.frame, text = 'Label 1', background = 'blue').pack(expand = True, fill = 'both', padx = 10, pady = 5)
        ttk.Label(self.frame, text = 'Label 1', background = 'yellow').pack(expand = True, fill = 'both', padx = 10, pady = 5)
        self.frame.pack(expand = True, fill = 'both')
    ...
    def create_medium_layout(self):
        ...
        ttk.Label(self.frame, text = 'Label 1', background = 'green').grid(column = 1, row = 0, sticky = 'nsew', padx = 10, pady = 10)
        ttk.Label(self.frame, text = 'Label 1', background = 'blue').grid(column = 0, row = 1, sticky = 'nsew', padx = 10, pady = 10)
        ttk.Label(self.frame, text = 'Label 1', background = 'yellow').grid(column = 1, row = 1, sticky = 'nsew', padx = 10, pady = 10)
    ...
    def create_large_layout(self):
        ...
        ttk.Label(self.frame, text = 'Label 1', background = 'red').grid(column = 0, row = 0, sticky = 'nsew', padx = 10, pady = 10)
        ttk.Label(self.frame, text = 'Label 1', background = 'green').grid(column = 1, row = 0, sticky = 'nsew', padx = 10, pady = 10)
        ttk.Label(self.frame, text = 'Label 1', background = 'blue').grid(column = 2, row = 0, sticky = 'nsew', padx = 10, pady = 10)
        ttk.Label(self.frame, text = 'Label 1', background = 'yellow').grid(column = 3, row = 0, sticky = 'nsew', padx = 10, pady = 10)
...
# exercise
# create a third layout where the widgets are next to each other (I used grid)
